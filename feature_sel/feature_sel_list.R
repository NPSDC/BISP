source('feature_sel/shrunken_features.R')
source('feature_sel/varselrf_features.R')
source('feature_sel/deseq_features.R')
source('feature_sel/sam_features.R')
...
get.varSelRf.features.group <- function(train.data, train.stages, train.ind.list, cores = 1, type = 1)
{
  ...
  varselRF.features[['genes.object']] <- get.varselRF.object(data = train.data, 
                                                             ...
                                                             type = type)
  varselRF.features[['genes.list']] <- get.min.oob.varselRf(varselRf.ob.list = varselRF.features$genes.object)
  no.groups <- length(train.ind.list)
  groups.name <- paste(rep('atleast', no.groups), seq(no.groups), sep = '_')
